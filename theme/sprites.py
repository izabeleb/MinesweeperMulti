...
from theme._constants import cellImageDir, widgetImageDir
...
class Box(pygame.sprite.Sprite):
    def __init__(self, size: int, coords: tuple):
...
class Digit(pygame.sprite.Sprite):
    ...
    def __init__(self, w: int, h: int, left: int, top: int, value: int):
        ...
        self.image = self.image = pygame.transform.scale(
            pygame.image.load(f"{widgetImageDir}/{value}.png"), (self.width, self.height)) \
            .convert_alpha()
    ...
    def change_digit(self, value: int):
        ...
        self.image = pygame.transform.scale(
            pygame.image.load(f"{widgetImageDir}/{self.value}.png"), (self.width, self.height)) \
            .convert_alpha()
...
class BombCounter(pygame.sprite.Sprite):
    ...
    def __init__(self, w, h, digit1: Digit, digit2: Digit, digit3: Digit, bomb_num):
        pygame.sprite.Sprite.__init__(self)
...
class Timer(pygame.sprite.Sprite):
    ...
    def __init__(self, w: int, h: int, right: int, top: int, digit1: Digit, digit2: Digit,
                 digit3: Digit):
        pygame.sprite.Sprite.__init__(self)
    ...
    def update(self):
        if self.initialized:
            ...
            if elapsedTime >= 100:
                self.digit1.change_digit(stringTime[0])
                self.digit2.change_digit(stringTime[1])
                self.digit3.change_digit(stringTime[2])

            elif elapsedTime >= 10:
                self.digit2.change_digit(stringTime[0])
                self.digit3.change_digit(stringTime[1])

            else:
                self.digit3.change_digit(stringTime[0])
...
class Label(pygame.sprite.Sprite):
    ...
    def __init__(self, name, text, loc, alignment, bg_color=None, size=30, color=ColorTheme.MENU_TEXT_ITEM):
        """
